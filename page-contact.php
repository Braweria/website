...
<section class="section-block bg-lr">
    <div class="container contact">
      ...
      <div class="contact-social">
        <a href="https://twitter.com/Braweria"><button class="primary"><i class="fab fa-twitter"></i></button></a>
        <a href="https://www.behance.net/braweria"><button class="primary"><i class="fab fa-behance"></i></button></a>
        <a href="https://github.com/Braweria"><button class="primary"><i class="fab fa-github"></i></button></a>
        <a href="https://www.reddit.com/u/braweria"><button class="primary"><i class="fab fa-reddit-alien"></i></button></a>
      </div>
    </div>
  </section>
