...
<section class="section-block bg-lr">
    <div class="container contact">
      ...
      <div class="contact-social">
        ...
        <a href="https://github.com/Braweria"><button aria-label="Zu meinem Github wechseln" class="primary"><i class="fab fa-github"></i></button></a>
        <a href="https://www.reddit.com/u/braweria"><button aria-label="Zu meinem Reddit wechseln" class="primary"><i class="fab fa-reddit-alien"></i></button></a>
      </div>
    </div>
  </section>
